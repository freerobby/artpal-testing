...
?>	
		<li id="steira_about_text-4" class="widget widget_steira_about_text">
			<h2><?php _e('About This Site', 'theme'); ?></h2>
			<div class="aboutshort">
				<p><?php _e('You can use the Steira "About" Text Widget to add some text about your site here.', 'theme'); ?></p>
			</div>
		</li>
		
		<li id="steira_recent_posts-7" class="widget widget_steira_recent_posts">
			<h2><?php _e('Recent Posts', 'theme'); ?></h2>
		<?php

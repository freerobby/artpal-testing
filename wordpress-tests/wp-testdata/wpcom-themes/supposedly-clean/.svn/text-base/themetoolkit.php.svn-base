...
//			$this->pluginification();
		...
		function add_menu() {
			...
			$page_title = sprintf(__('Configure %s', 'supposedly-clean'), $this->infos['theme_name']);
			add_theme_page($page_title, __('Theme Options', 'supposedly-clean'), 'edit_themes', basename($this->file), array(&$this,'admin_menu'));

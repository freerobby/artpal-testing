...
function wptouch_core_header_enqueue() {
	$version = get_bloginfo('version'); 
		...
		wp_enqueue_script('wptouch-core', '' . get_stylesheet_directory_uri() . '/core/core.js', array('jquery'),'1.9' );		
		wp_head(); 
...
echo '<script type="text/javascript">function switch_delayer() { window.location = "' . get_bloginfo('siteurl') . '/?ak_action=reject_mobile"}</script>';

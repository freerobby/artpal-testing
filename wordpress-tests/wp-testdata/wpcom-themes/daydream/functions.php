...
function dd_admin() {
	...
	if ( $_GET['saved'] ) echo '<div id="message" class="updated fade"><p>' . _e('Day Dream options saved.', 'daydream') . '<a href="'. get_bloginfo('url') .'">' . _e('View Site &raquo;', 'daydream') . '</a></strong></p></div>';

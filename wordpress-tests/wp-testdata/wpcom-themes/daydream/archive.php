	...
	<div id="content" class="sanda">
		...
		<?php if (have_posts()) : ?>
			...
			<?php /* If this is a search */ } elseif (is_search()) { ?>
				<h2 class="pagetitle"><?php printf(__('Search Results for %s', 'daydream'), $s); ?></h2>
			...
			<?php } ?>
				...
				<?php while (have_posts()) : the_post(); ?>
					...
					<div <?php post_class(); ?>>
						...
						<h3 id="post-<?php the_ID(); ?>"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link to', 'daydream');?>  <?php the_title(); ?>"><?php the_title(); ?></a><br />

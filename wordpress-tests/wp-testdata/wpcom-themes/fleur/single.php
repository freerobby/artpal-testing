...
<div id="rap">
	...
	<div id="main">
		<div id="content">
			<?php if ($posts) : foreach ($posts as $post) : the_post(); ?>			
				<div <?php post_class(); ?>>
	<h2 class="post-title">
		<em><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link:'); ?> <?php the_title(); ?>"><?php the_title(); ?></a></em>
	...
	<p class="post-info"><a href="<?php trackback_url(display); ?> "><?php _e('Trackback URI'); ?></a></a>
...
<p id="footer">
<a href="http://wordpress.com/" rel="generator"><?php _e('Get a free blog at WordPress.com<'); ?>/a>
</p>

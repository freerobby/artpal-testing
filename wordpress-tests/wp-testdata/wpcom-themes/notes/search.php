...
<?php if ( have_posts() ) : ?>
		...
		<h2 class="page-title"><?php _e( 'Search Results for:', 'notesil' ) ?> <span><?php the_search_query() ?></span></h2>
...
<?php while ( have_posts() ) : the_post() ?>
			...
			<div id="post-<?php the_ID() ?>" class="<?php sandbox_post_class() ?>">
				...
				<div class="entry-date"><abbr class="published" title="<?php the_time('Y-m-d\TH:i:sO') ?>"><?php unset($previousday); printf( __( '%1$s &#8211; %2$s', 'notesil' ), the_date( '', '', '', false ), get_the_time() ) ?></abbr></div>
...
<?php if ( $post->post_type == 'post' ) { ?>
				<div class="entry-meta">
					<span class="author vcard"><?php printf( __( 'By %s', 'notesil' ), '<a class="url fn n" href="' . get_author_link( false, $authordata->ID, $authordata->user_nicename ) . '" title="' . sprintf( __( 'View all posts by %s', 'notesil' ), $authordata->display_name ) . '">' . get_the_author() . '</a>' ) ?></span>
...
<?php else : ?>
			...
			<div id="post-0" class="post no-results not-found">
				<h2 class="entry-title"><?php _e( 'Nothing Found', 'notesil' ) ?></h2>
				<div class="entry-content">

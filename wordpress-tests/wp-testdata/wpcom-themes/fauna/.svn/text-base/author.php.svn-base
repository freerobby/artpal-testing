	...
	<div id="body">
		...
		<div id="main" class="entry">
			...
			<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
				...
				<p><?php _e('You can follow entries authored by', 'fauna') ?> <?php the_author_meta('user_nicename'); ?> <?php _e('via an', 'fauna') ?> <a href="<? echo get_author_rss_link(0, $author, $author_nicename); ?>" title="<?php _e('RSS 2.0', 'fauna') ?>"><?php _e('author-only XML feed', 'fauna') ?></a>.</p>

...
<?php the_post(); ?>			
          ...
          <h2 class="page-title author"><?php printf( __( 'Author Archives: <strong class="vcard">%s</strong>', 'theme' ), "<a class='url fn n' href='$authordata->user_url' title='$authordata->display_name' rel='me'>$authordata->display_name</a>" ) ?></h2>
